        ...
        return (
            <div className="About">
                ...
                <span>
                    ...
                    <a href="https://www.capoeira.chat" target="_blank">CapoeiraSongBot</a>
                    & 
                    <a href="https://www.stockoverflow.app" target="_blank">StockOverflow</a>
                    apps, as well as the founder of
                    <a href="https://www.aruanda.de" target="_blank">Aruanda Frankfurt</a>
                    ...
                    <a href="https://company.acomodeo.com" target="_blank">lead developer at Acomodeo</a>
                    . In June 2019 I returned to my hometown Hamburg to work as a
                    <a href="https://www.finanzcheck.de" target="_blank">full-stack developer at Finanzcheck</a>
                ...
                <span>
                    ...
                    <a href="https://www.github.com/samihamed" target="_blank">projects I'm currently developing</a>
