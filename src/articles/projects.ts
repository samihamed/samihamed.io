...
The CapoeiraSongBot is a Telegram chatbot which enables users to access a total of 2166 capoeira songs through the interface of their Telegram application on mobile and/or desktop. It understands English and Portuguese language, supports a whole lot of different inputs and returns lyrics, songs and helpful information based on a set of predefined calculations.
