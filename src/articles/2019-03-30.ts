...
Seeing what was possible in the scope of a ‘modern’ web application made me realise how much I would enjoy being able to make things move on the screen on my own. So I started searching for online courses on web development, diving into Javascript tutorials, figuring out how to make buttons move with jQuery and how to create a simple blog with Ruby (on Rails) and my SPA-framework of choice, AngularJs.
...
// Since joining the team I had added more than 150.000 lines of code to the products I was asked to develop and maintain. That’s at least what Github told me.
